...
create table if not exists public.study_practice_attempts (
  ...
  score int,
  total_questions int,
  scored_questions_count int,
  written_questions_count int not null default 0,
  written_answered_count int not null default 0,
...
create table if not exists public.study_attempt_answers (
  ...
  text_answer text,
  confidence text check (confidence is null or confidence in ('confident', 'unsure', 'guessed')),
  is_correct boolean,
  understood boolean,
  ai_grade_score numeric(4,1),
  ai_grade_max_score integer,
  ai_grade_verdict text,
  ai_grade_feedback text,
  ai_grade_matched_points jsonb not null default '[]'::jsonb,
  ai_grade_missing_points jsonb not null default '[]'::jsonb,
  ai_grade_improved_answer text,
  ai_grade_provider text,
  ai_grade_model text,
  ai_grade_answer_hash text,

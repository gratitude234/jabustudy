...
export default function ExamError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="grid min-h-[60vh] place-items-center py-10">
      <div className="w-full max-w-md rounded-2xl border border-rose-300/50 bg-card p-6 text-center shadow-sm dark:border-rose-800/50">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <Link href="/study" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-border px-4 text-sm font-black no-underline"><ArrowLeft className="h-4 w-4" /> Study Hub</Link>

        ...
        <div className="grid gap-5 lg:grid-cols-[0.9fr,1.1fr]">
          ...
          <section className="rounded-3xl border border-primary/20 bg-primary/[0.04] p-5 shadow-sm">
            ...
            <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-primary" /> 40 reviewed questions in 40 minutes</li>
              <li className="flex gap-2"><RotateCcw className="mt-0.5 h-4 w-4 shrink-0 text-primary" /> Unlimited retakes with a fresh randomized mix</li>

        ...
        {banner ? (
          <div
            className={cn(
              ...
              banner.kind === "error" && "border-red-200 bg-red-50 text-red-800 dark:bg-red-950/40 dark:border-red-900 dark:text-red-400",
              banner.kind === "success" && "border-emerald-200 bg-emerald-50 text-emerald-900 dark:bg-emerald-950/40 dark:border-emerald-900 dark:text-emerald-300",
              banner.kind === "info" && "border-blue-200 bg-blue-50 text-blue-900 dark:bg-blue-950/40 dark:border-blue-900 dark:text-blue-400"
            )}
          >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        active
                          ? d === "" ? "border-zinc-300 bg-zinc-100 text-zinc-700"
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          disabled={qBusy}
                          className={cn(
                            "inline-flex items-center gap-2 rounded-2xl border border-red-200 bg-white px-3 py-2 text-sm font-semibold text-red-700 hover:bg-red-50 dark:bg-red-950/40 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-900/40",
                            qBusy ? "opacity-60" : ""
                          )}
                        >
                    ...
                    {open ? (
                      <div className="mt-4 grid gap-3">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {isWritten ? (
                            <span className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-800 dark:bg-blue-950/40 dark:border-blue-900 dark:text-blue-400">
                              Written answer
                            </span>
                          ) : hasCorrect ? (
                            ...
                            <span className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-900 dark:bg-amber-950/40 dark:border-amber-900 dark:text-amber-400">

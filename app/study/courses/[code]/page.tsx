        ...
        <>
          ...
          <div className="rounded-3xl border border-border bg-card p-4 shadow-sm">
            ...
            {practiceSets.length > 0 ? (
              ...
              <p className="text-sm text-muted-brand mb-3">
                No practice sets yet. Use materials below to revise.
              </p>
            )}

            <a
              href={`https://wa.me/2347041022336?text=${encodeURIComponent(`Hi! Please I need practice sets for ${code}${course?.course_title ? ` (${course.course_title})` : ""} on JabuStudy.`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex w-full items-center justify-center gap-2 rounded-2xl border border-dashed border-[#25D366]/40 bg-[#25D366]/5 px-4 py-2.5 text-sm font-semibold text-[#25D366] no-underline transition hover:bg-[#25D366]/10"
            >

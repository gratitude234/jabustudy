  ...
  return (
    <div className="pb-28 md:pb-6 lg:flex lg:items-start lg:gap-6">
      ...
      <a
        ...
        className="flex items-center gap-3 rounded-2xl border border-border bg-card p-4 no-underline transition hover:border-[#25D366]/40 hover:bg-[#25D366]/5"
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-foreground">Got a problem or question?</p>
          <p className="text-xs text-muted-foreground">Chat us on WhatsApp — we reply fast.</p>
        </div>
